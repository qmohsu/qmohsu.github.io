---
title: "通用車輛自我診斷 —— 預測性部件監測"
slug: "vehicle-self-diagnosis"
description: "用車端資料流做即時預測性部件監測 —— 把完整性的弧線從定位擴展到整車健康。HK Smart Traffic Fund 項目。"
...
本項目研發一套<strong>通用、資料驅動、即時的汽車部件預測性自我診斷系統</strong> —— 把保障 GNSS 導航的故障偵測 / 完整性監測方法論,應用到更廣泛的整車系統健康監測問題上。車輛從數十個部件產生稠密的時序資料流;目標是在故障真正發生<strong>之前</strong>預測它,跨車型、跨工況通用。
