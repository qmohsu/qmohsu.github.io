...
<img src="/images/research/blueprint-optimization-estimation.svg" alt="Blueprint: heterogeneous inputs (GNSS/INS, carrier and Doppler, maps and perception, constraints) become factors connecting state nodes over time in a factor graph, solved jointly into a robust trajectory." style="max-width:660px;width:100%;height:auto;display:block;margin:1.5rem auto;" />
