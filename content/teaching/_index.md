...
Students nourished through the lab's project-based teaching and the URIS undergraduate-research pipeline — led by **Max Lee** (now an HKPFS PhD candidate in AAE, mentored by Prof. Hsu since his award-winning undergraduate internship) with co-founder **Josua Chan** — evolved their **FJ005** project (Techathon Smart City Champion, 2021) into **[LifeSparrow Solutions](https://www.hkstp.org/en/directory/material-and-precision-engineering/lifesparrow-solutions-limited)**, whose **DIAS** system applies AI human-detection to drone imagery for **mountain search-and-rescue** — cutting search time by **more than 65%**.
...
- **Backing:** an **HKSTP incubatee**, with around **HK$1.8 million** raised from PolyU, Cyberport, and Hong Kong Science Park ([PolyU, 2024](https://www.polyu.edu.hk/publications/pulse-polyu/issue/202405/research-knowledge-transfer/polyu-alumni-named-forbes-30-under-30-asia-for-revolutionary-search-and-rescue-drone-system)).
