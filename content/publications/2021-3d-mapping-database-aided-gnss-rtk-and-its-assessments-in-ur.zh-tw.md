...
code: ""
data: ""
hero_image: "/images/pubs/2021-3dma-rtk-urban-skymask-hero.png"
hero_alt: "用於評估 3D mapping database-aided GNSS RTK 的城市場景測試點與 sky masks。"
hero_caption: "圖 3 視覺細節：香港測試點與 sky masks，用於評估 3D mapping database-aided GNSS RTK。"
figures:
  - src: "/images/pubs/2021-3dma-rtk-fig2-candidate-heatmap.png"
    ...
    context: "在流程定義 3D 地圖輔助 RTK 後，這張熱力圖展示在模糊度解算前如何給候選位置評分。"
    caption: "圖 2：利用載波相位一致性對位置假設進行評分。"
  - src: "/images/pubs/2021-3dma-rtk-fig3-experiment-skymask.png"
    ...
    context: "論文隨後在香港多個具有不同天際遮蔽模式的地點測試該方法，因此天空遮罩成為評估的核心。"
    caption: "圖 3：用於城市峽谷評估的實驗地點和天空遮罩。"
  - src: "/images/pubs/2021-3dma-rtk-fig4-equipment.png"
    ...
    context: "共用天線和接收機設定讓研究能在相同衛星環境下比較測地級與商用接收機。"
    caption: "圖 4：用於真值確定和 RTK 評估的實驗設備。"
  - src: "/images/pubs/2021-3dma-rtk-fig5-positioning-adop-pdop.png"
    ...
    context: "在實驗設定固定後，論文把定位誤差與模糊度精度因子、幾何精度因子和可用衛星數隨時間的變化連結起來。"
    caption: "圖 5：定位誤差、模糊度精度因子、幾何精度因子和衛星數的時間序列比較。"
  - src: "/images/pubs/2021-3dma-rtk-fig6-7-cdf-boxplot.png"
    ...
    context: "時間序列表現進一步用統計方式總結，說明 3DMA 輔助 RTK 在多大比例上改善了 2D 誤差分布。"
    caption: "圖 6 和圖 7：2D 定位誤差的分布和箱形圖總結。"
  - src: "/images/pubs/2021-3dma-rtk-fig8-position-heatmap-skymask.png"
    ...
    context: "這個診斷案例透過比較位置熱力圖和候選位置的可見性判斷來解釋評分行為。"
    caption: "圖 8：用於解釋雜訊觀測案例的位置熱力圖和天空遮罩比較。"
  - src: "/images/pubs/2021-3dma-rtk-fig10-positioning-visibility.png"
    ...
    context: "長時間實驗檢查同一套基於可見性的邏輯在數小時城市資料中是否保持穩定。"
    caption: "圖 10：三小時定位誤差和可見性分類正確率。"
project: "3dma-gnss"
themes:
