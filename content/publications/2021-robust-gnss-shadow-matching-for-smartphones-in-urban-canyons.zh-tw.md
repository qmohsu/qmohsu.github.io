...
hero_alt: "用於 smartphone GNSS shadow matching 的 urban canyon 測試點與預測 sky mask。"
hero_caption: "圖 6 視覺細節：urban canyon 測試點與預測 sky mask，用於 smartphone shadow matching。"
figures:
